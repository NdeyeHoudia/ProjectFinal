package com.Project9.MicroserviceGestationRisque.model;

public  class KeyWord {
    public static final String hemoglobine = "hémoglobine";
    ...
    public static final String anormal = "anormale";
    public static final String cholesterol = "cholestérol";
    public static final String vertiges ="vertiges";
    ...
    public static final String[] keyWord =
            {"hémoglobine","microalbumine","taille", "poids", "fumeur","anormale","cholestérol", "vertiges","rechute","réaction","anticorps","stress"}
;
}
